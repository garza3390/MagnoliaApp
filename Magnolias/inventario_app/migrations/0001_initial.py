# Generated by Django 4.2.16 on 2024-11-18 08:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia_proxima_visita', models.DateField(blank=True, default='2024-11-30', null=True)),
                ('rango_fecha_inicio', models.DateField(default='2024-11-18')),
                ('rango_fecha_fin', models.DateField(default='2024-11-18')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semana', models.CharField(default='', max_length=9)),
                ('co_tienda', models.CharField(default='000', max_length=3)),
                ('fecha_visita_anterior', models.DateField(blank=True, null=True)),
                ('fecha_visita_actual', models.DateField(blank=True, default='2024-11-18', null=True)),
