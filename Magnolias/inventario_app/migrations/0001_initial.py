# Generated by Django 4.2.16 on 2024-11-12 02:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre_cadena",
                    models.CharField(default="Inversiones AMPM S.A.", max_length=50),
                ),
                (
                    "cedula_juridica",
                    models.CharField(default="3-102-811609", max_length=12),
                ),
                ("semana_proceso", models.CharField(default="2000-43", max_length=9)),
                (
                    "dia_proxima_visita",
                    models.DateField(blank=True, default="2000-10-10", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grupo_tienda",
                    models.CharField(
                        choices=[("AMPM", "AMPM"), ("FM", "FM")], max_length=4
                    ),
                ),
                ("ruta_secuencial_temp", models.CharField(max_length=3)),
                ("ruta_secuencial_fija", models.CharField(max_length=3)),
                (
                    "horario_cierre_bodega",
                    models.CharField(choices=[("11-12", "11-12"), ("12-13", "12-13")]),
                ),
                ...
                ("direccion", models.CharField(default="", max_length=600)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("co_tienda", models.CharField(default="000", max_length=3)),
                ...
                ("inventario_inicial", models.TextField(blank=True, null=True)),
                ...
                ("venta_real", models.TextField(default="[0,0,0,0,0]")),
                ...
                (
                    "registro_bloqueado",
                    models.CharField(
                        choices=[("S", "Sí"), ("N", "No")], default="N", max_length=1
                    ),
                ),
                (
                    "codigo_tienda",
                    models.ForeignKey(
                        ...
                        to="inventario_app.tiendadetalle",
                    ),
                ),
            ],
            options={
